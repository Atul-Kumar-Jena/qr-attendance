    ...
    <section ref={root} className="hero-section section-dark relative pt-40 pb-28 md:pt-52 md:pb-40 overflow-hidden">
      ...
      <div className="container relative z-10">
        <div className="grid lg:grid-cols-[1.15fr_1fr] gap-14 lg:gap-20 items-center">
              ...
              {HEADLINE.map((line, i) => (
                <span key={i} className="hero-line block reveal-mask">
                  <span className="reveal-line">
                    {i === 1
                      ? <em className="not-italic bg-clip-text text-transparent bg-gradient-to-r from-accent via-accent-rose to-accent-violet">{line}</em>
                      : line}
                  </span>
                </span>
              ))}
          ...
          {/* QR mosaic — the core product idea */}
...
function QrMosaic() {
  ...
  return (
    <div className="relative h-full w-full">
      ...
      {/* Countdown ring — now monochrome white */}
