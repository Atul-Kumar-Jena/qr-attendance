            ...
            return (
              <div
                ...
                className={`tier rounded-2xl p-8 border transition-all ${
                  t.highlight
                    ? 'bg-ink dark:bg-[#13261B] text-cream-50 border-ink dark:border-white/10 shadow-[0_30px_80px_-20px_rgba(11,18,32,0.4)]'
                  ...
                  <Magnetic strength={0.2}>
                    <a
                      ...
                      className={`inline-flex w-full justify-center items-center gap-1.5 rounded-full px-5 py-3 text-[13px] font-medium ${
                        t.highlight ? 'bg-accent text-cream-50' : 'bg-ink dark:bg-[#13261B] dark:border dark:border-white/10 text-cream-50'
                      }`}
                    >
                      {isFree
