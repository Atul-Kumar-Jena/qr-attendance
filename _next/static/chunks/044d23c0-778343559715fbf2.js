 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e8(e,t,r=!1){if((0,i.rh)(e.app))return Promise.reject(m(e));let n="signIn",s=await e5(e,n,t),a=await e3._fromIdTokenResponse(e,n,s);return r||await e._updateCurrentUser(a.user),a}function e7(e){return(0,s.m9)(e).signOut()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
